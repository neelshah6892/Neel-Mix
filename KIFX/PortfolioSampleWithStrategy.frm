...
Begin VB.Form frmPortfolioSampleWithStrategy 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Portfolio Sample With Strategy"
   ClientHeight    =   9240
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11160
   Icon            =   "PortfolioSampleWithStrategy.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9240
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdExcelList 
            Height          =   375
            Left            =   11325
            Picture         =   "PortfolioSampleWithStrategy.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmdCalculator 
            Height          =   375
            Left            =   10890
            Picture         =   "PortfolioSampleWithStrategy.frx":0394
            Style           =   1  'Graphical
            TabIndex        =   11
      ...
      Begin VB.CommandButton cmdClose 
         ...
         Height          =   345
         Left            =   14655
         Picture         =   "PortfolioSampleWithStrategy.frx":08AC
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Close"
         Top             =   60
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         EndProperty
         TabCaption(0)   =   "Tab 0"
         TabPicture(0)   =   "PortfolioSampleWithStrategy.frx":09A6
   ...
   End
End
Attribute VB_Name = "frmPortfolioSampleWithStrategy"

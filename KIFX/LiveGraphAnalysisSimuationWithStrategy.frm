...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton cmdExcelList 
      ...
      Height          =   330
      Left            =   11205
      Picture         =   "LiveGraphAnalysisSimuationWithStrategy.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   47
      TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmdGraph 
      Height          =   330
      Left            =   12495
      Picture         =   "LiveGraphAnalysisSimuationWithStrategy.frx":0388
      Style           =   1  'Graphical
      TabIndex        =   33
   ...
   Begin VB.CommandButton cmdClose 
      ...
      Height          =   345
      Left            =   11640
      Picture         =   "LiveGraphAnalysisSimuationWithStrategy.frx":09FA
      Style           =   1  'Graphical
      TabIndex        =   32
      ToolTipText     =   "Close"
      Top             =   0
   ...
   Begin VB.Frame fraMain 
      ...
      Begin VB.Frame fraDaysScale 
         ...
         Begin VB.CommandButton cmdDaysClear 
            Height          =   360
            Left            =   3420
            Picture         =   "LiveGraphAnalysisSimuationWithStrategy.frx":0AF4
            Style           =   1  'Graphical
            TabIndex        =   19
            ToolTipText     =   "Clear"
            Top             =   1095
      ...
      Begin VB.Frame fraRateScale 
         ...
         Begin VB.CommandButton cmdClear 
            Height          =   360
            Left            =   3450
            Picture         =   "LiveGraphAnalysisSimuationWithStrategy.frx":0BEE
            Style           =   1  'Graphical
            TabIndex        =   12
            ToolTipText     =   "Clear"
            Top             =   1155
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "Graph"
      TabPicture(0)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0CE8
      ...
      TabPicture(1)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D04
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "msfGrid"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "IV's And LTP"
      TabPicture(2)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D20
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "lstDetails1"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Rate Vs Days (Delta Neut.)"
      TabPicture(3)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D3C
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "msfGrid2"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "Rate Vs Days (Delta Val)"
      TabPicture(4)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D58
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "msfGridDeltaVal"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "Rate Vs Days (Theta Val)"
      TabPicture(5)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D74
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "msfGridThetaVal"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "Rate Vs Days (Vega Val)"
      TabPicture(6)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0D90
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "msfGridVegaVal"
      Tab(6).ControlCount=   1
      TabCaption(7)   =   "Rate Vs Days (Gamma Val)"
      TabPicture(7)   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0DAC
      ...
      Begin VB.ComboBox cmbGraphType 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "LiveGraphAnalysisSimuationWithStrategy.frx":0DC8
         Left            =   1140
         List            =   "LiveGraphAnalysisSimuationWithStrategy.frx":0DF0
         Style           =   2  'Dropdown List
         TabIndex        =   50
         Top             =   660
         Width           =   2310
      ...
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   6825
         Left            =   120
         OleObjectBlob   =   "LiveGraphAnalysisSimuationWithStrategy.frx":0E6A
         TabIndex        =   49
         Top             =   1005
         Width           =   11760
      End
